              ...
              <tr>
                <td>
                  <div class="text" style="padding: 0 2.5em; text-align: center;">
                    ...
                    <h3>copy this link : ${resetURL} </h3>
                    <p><a href="${resetURL}" style="color: white; padding:10px 15px; background-color: black; border-radius:8px" class="btn btn-primary">Reset Password</a></p>
                  </div>
                </td>
              </tr>
            </table>
